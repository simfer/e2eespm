jQuery.sap.declare("com.test.e2e.Component");
jQuery.sap.require("com.test.e2e.MyRouter");

sap.ui.core.UIComponent.extend("com.test.e2e.Component", {
	metadata : {
		name : "TDG Demo App",
		version : "1.0",
		includes : [],
		...
		rootView : "com.test.e2e.view.App",

		config : {
			resourceBundle : "i18n/messageBundle.properties",
			serviceConfig : {
				name: "/ESPM_V1/api/",
				serviceUrl: "/destinations/ESPM/ESPM_V1/api/"
			}
		},

		routing : {
			config : {
				routerClass : com.test.e2e.MyRouter,
				viewType : "XML",
				viewPath : "com.test.e2e.view",
	...
	init : function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.test.e2e");
