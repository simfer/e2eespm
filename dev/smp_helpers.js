...
//     var uHeader = {"Authorization":auth, "Cache-Control" : "no-cache, no-store"};
...
//     //     title : "Please Wait..",
//     //     text : "Creating Offline DB"});
//     // busyIndicator.open();

//     function successOfflineOpen() {
...
//     function errorOfflineOpen() {
// //        busyIndicator.close();
//         errorCallback();
//     }

//     //var options = {};
//     store.open(successOfflineOpen(), errorOfflineOpen());
// }
...
//         showCancelButton :false,
//         title : "Please Wait..",
//         text : "Flushing Offline Changes"});
//     busyIndicator.open();
    
//     function flushStoreErrorCallback() {
//         busyIndicator.close();
//         errorCallback();
//     }
...
//     store.flush(flushStoreSuccessCallback, flushStoreErrorCallback);
// }
...
//     function refreshErrorCallback(e) {
//         busyIndicator.close();
//         jQuery.sap.require("sap.m.MessageBox");
//         sap.m.MessageBox.alert(e, "Error");
//     }
...
//         store.refresh(refreshStoreCallback, refreshErrorCallback);
